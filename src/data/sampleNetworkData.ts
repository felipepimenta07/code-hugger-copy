...
export const SAMPLE_PEOPLE = [
  // Workflow 1: Tech - Layout Radial (center: 500, 400) - Anel Inner
  { id: 101, name: 'Felipe Martins', type: 'person', company: 'Agência X', workflows: [1, 2], category: 'Profissional', email: 'felipe@agenciax.com', x: 500, y: 220 },
  { id: 102, name: 'Ana Silva', type: 'person', company: 'Agência X', workflows: [1, 3], category: 'Profissional', email: 'ana@agenciax.com', x: 655, y: 310 },
  { id: 103, name: 'João Tech', type: 'person', company: 'Tech Corp', workflows: [1, 3, 5], category: 'Profissional', x: 655, y: 490 },
  { id: 104, name: 'Maria Dev', type: 'person', company: 'Startup Y', workflows: [1], category: 'Profissional', x: 500, y: 580 },
  { id: 105, name: 'Carlos Code', type: 'person', company: 'Tech Corp', workflows: [1, 3], category: 'Profissional', x: 345, y: 490 },
  { id: 116, name: 'Luiza Design', type: 'person', company: 'Agência X', workflows: [1, 2], category: 'Profissional', x: 345, y: 310 },
  
  // Anel Middle
  { id: 117, name: 'Rafael Backend', type: 'person', company: 'Tech Corp', workflows: [1], category: 'Profissional', x: 500, y: 80 },
  { id: 118, name: 'Sofia UX', type: 'person', company: 'Startup Y', workflows: [1, 5], category: 'Profissional', x: 820, y: 400 },
  
  // Workflow 2: Eventos - Layout Radial (center: 1500, 400)
  { id: 106, name: 'Paula Eventos', type: 'person', company: 'EventCo', workflows: [2], category: 'Profissional', x: 1500, y: 220 },
  { id: 107, name: 'Ricardo PR', type: 'person', company: 'Campari', workflows: [2, 3], category: 'Cliente', x: 1655, y: 310 },
  { id: 108, name: 'Juliana Marketing', type: 'person', company: 'Shopping X', workflows: [2], categoria: 'Cliente', x: 1655, y: 490 },
  
  // Workflow 3: Parcerias - Layout Radial (center: 2500, 400)
  { id: 109, name: 'Fernando CEO', type: 'person', company: 'Tech Corp', workflows: [3, 5], category: 'Parceiro', x: 2500, y: 220 },
  { id: 110, name: 'Beatriz CFO', type: 'person', company: 'Invest Plus', workflows: [3, 5], category: 'Parceiro', x: 2655, y: 310 },
  
  // Workflow 4: Família - Layout Radial (center: 500, 1300)
  { id: 111, name: 'Maria (Mãe)', type: 'person', workflows: [4], category: 'Pessoal', x: 500, y: 1120 },
  { id: 112, name: 'Pedro (Irmão)', type: 'person', company: 'Tech Corp', workflows: [4, 1], category: 'Pessoal', x: 655, y: 1210 },
  { id: 113, name: 'João Primo', type: 'person', company: 'Startup Y', workflows: [4, 5], category: 'Pessoal', x: 655, y: 1390 },
  
  // Workflow 5: Investimentos - Layout Radial (center: 1500, 1300)
  { id: 114, name: 'Roberto Investidor', type: 'person', company: 'XP Investimentos', workflows: [5], category: 'Parceiro', x: 1500, y: 1120 },
  { id: 115, name: 'Sócio Alpha', type: 'person', company: 'Startup Alpha', workflows: [5, 1], category: 'Parceiro', x: 1655, y: 1210 }
];

export const SAMPLE_BRANDS = [
  // Workflow 1: Tech - Layout Radial (center: 500, 400) - Anel Middle
  { id: 204, name: 'Tech Corp', type: 'brand', category: 'Tecnologia', workflows: [1, 3, 5], website: 'techcorp.com', x: 180, y: 400 },
  { id: 206, name: 'Startup Y', type: 'brand', category: 'Tecnologia', workflows: [1, 5], website: 'startupy.com', x: 500, y: 720 },
  { id: 208, name: 'Agência X', type: 'brand', category: 'Serviços', workflows: [1, 2], website: 'agenciax.com', x: 820, y: 240 },
  
  // Workflow 2: Eventos - Layout Radial (center: 1500, 400)
  { id: 201, name: 'Campari', type: 'brand', category: 'Bebida', workflows: [2], website: 'campari.com', x: 1500, y: 580 },
  { id: 202, name: 'Shopping X', type: 'brand', category: 'Varejo', workflows: [2, 3], website: 'shoppingx.com', x: 1345, y: 490 },
  { id: 203, name: 'Marriott Hotel', type: 'brand', category: 'Hotelaria', workflows: [2], website: 'marriott.com', x: 1345, y: 310 },
  { id: 205, name: 'EventCo', type: 'brand', category: 'Serviços', workflows: [2], website: 'eventco.com', x: 1820, y: 400 },
  
  // Workflow 3: Parcerias - Layout Radial (center: 2500, 400)
  { id: 210, name: 'Invest Plus', type: 'brand', category: 'Serviços', workflows: [3, 5], website: 'investplus.com', x: 2655, y: 490 },
  
  // Workflow 5: Investimentos - Layout Radial (center: 1500, 1300)
  { id: 207, name: 'XP Investimentos', type: 'brand', category: 'Serviços', workflows: [5], website: 'xpi.com.br', x: 1345, y: 1390 },
  { id: 209, name: 'Startup Alpha', type: 'brand', category: 'Tecnologia', workflows: [5], website: 'startupalpha.com', x: 1500, y: 1480 }
];
