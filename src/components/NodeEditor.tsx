...
export const NodeEditor: React.FC<NodeEditorProps> = ({
  ...
  // Resetar preview quando o nó mudar
  useEffect(() => {
            ...
            <div className="space-y-1">
              ...
              <div className="space-y-3 pt-2">
                ...
                <div>
                  ...
                  <input 
                    type="tel" 
                    value={node.phone_secondary || ''} 
                    onChange={(e) => onUpdate('phone_secondary', e.target.value)}
                    placeholder="(00) 00000-0000"
                    className="w-full px-4 py-2.5 bg-secondary border border-border rounded-xl text-foreground focus:outline-none focus:ring-2 focus:ring-primary"
                  />
                </div>
                <div>
                  ...
                  <input 
                    type="tel" 
                    value={node.phone_work || ''} 
                    onChange={(e) => onUpdate('phone_work', e.target.value)}
                ...
                <div>
                  ...
                  <input 
                    type="email" 
                    value={node.email_secondary || ''} 
                    onChange={(e) => onUpdate('email_secondary', e.target.value)}
